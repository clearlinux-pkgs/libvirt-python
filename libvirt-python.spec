...
Version  : 9.0.0
Release  : 103
URL      : https://github.com/libvirt/libvirt-python/archive/v9.0.0/libvirt-python-9.0.0.tar.gz
Source0  : https://github.com/libvirt/libvirt-python/archive/v9.0.0/libvirt-python-9.0.0.tar.gz
...
%prep
%setup -q -n libvirt-python-9.0.0
cd %{_builddir}/libvirt-python-9.0.0
pushd ..
cp -a libvirt-python-9.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673888107
