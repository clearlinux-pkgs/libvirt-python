...
Version  : 10.3.0
Release  : 121
URL      : https://github.com/libvirt/libvirt-python/archive/v10.3.0/libvirt-python-10.3.0.tar.gz
Source0  : https://github.com/libvirt/libvirt-python/archive/v10.3.0/libvirt-python-10.3.0.tar.gz
...
%prep
%setup -q -n libvirt-python-10.3.0
cd %{_builddir}/libvirt-python-10.3.0
pushd ..
cp -a libvirt-python-10.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714666483
