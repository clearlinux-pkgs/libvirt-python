...
Version  : 10.1.0
Release  : 119
URL      : https://github.com/libvirt/libvirt-python/archive/v10.1.0/libvirt-python-10.1.0.tar.gz
Source0  : https://github.com/libvirt/libvirt-python/archive/v10.1.0/libvirt-python-10.1.0.tar.gz
...
%prep
%setup -q -n libvirt-python-10.1.0
cd %{_builddir}/libvirt-python-10.1.0
pushd ..
cp -a libvirt-python-10.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709319250
