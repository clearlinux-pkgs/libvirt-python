...
Version  : 7.9.0
Release  : 83
URL      : https://github.com/libvirt/libvirt-python/archive/v7.9.0/libvirt-python-7.9.0.tar.gz
Source0  : https://github.com/libvirt/libvirt-python/archive/v7.9.0/libvirt-python-7.9.0.tar.gz
...
%prep
%setup -q -n libvirt-python-7.9.0
cd %{_builddir}/libvirt-python-7.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636047856
...
cp %{_builddir}/libvirt-python-7.9.0/COPYING %{buildroot}/usr/share/package-licenses/libvirt-python/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libvirt-python-7.9.0/COPYING.LESSER %{buildroot}/usr/share/package-licenses/libvirt-python/01a6b4bf79aca9b556822601186afab86e8c4fbf
