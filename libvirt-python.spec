...
Source0  : https://github.com/libvirt/libvirt-python/archive/v9.1.0/libvirt-python-9.1.0.tar.gz
...
%prep
%setup -q -n libvirt-python-9.1.0
cd %{_builddir}/libvirt-python-9.1.0
pushd ..
cp -a libvirt-python-9.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677685515
